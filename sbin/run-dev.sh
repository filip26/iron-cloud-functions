...
KMS_LOCATION=global KMS_KEY_RING=did-cel-keyring-1 KMS_KEY_ID=witness-indigo VERIFICATION_METHOD=did:key:z6Mkt4GJLRNdRhVPJjq8D4fuuqX44LtqgVsEV5o35xmjcjN4#z6Mkt4GJLRNdRhVPJjq8D4fuuqX44LtqgVsEV5o35xmjcjN4 mvn function:run -Drun.functionTarget=com.apicatalog.iron.gc.issuer.JcsIssuerService
